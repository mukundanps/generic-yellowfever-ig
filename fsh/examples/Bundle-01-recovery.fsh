...
* section[2].title = "COVID-19 Recovery Assertion"
* section[2].code = LOINC#19146-0 "Reference lab test panel"
* section[2].text.status = #generated
* section[2].text.div = "<div>Nothing here</div>"
* section[2].entry[0].reference = "urn:uuid:fb47f786-50d5-43b3-9534-a2f2ac176179" 
...
* performer.reference = "d7a490a1-d267-4785-ac98-db56748827fb"
* subject.reference = "2b90dd2b-2dab-4c75-9bb9-a355e07401e8"
* effectiveDateTime = "2020-09-04T14:30:00+01:00"

Instance: Inline-Instance-for-ips-Bundle-01-12
InstanceOf: DiagnosticReport
Usage: #inline
* id = "fb47f786-50d5-43b3-9534-a2f2ac176179"
* code = LOINC#19146-0 //Reference Lab test results
* status = SCT#292508471000119105 //History of COVID-19
* result.reference = "f96ad986-b5b4-42b6-b8b2-3e4b6c3b166d"
* result.component.code = SCT#404684003 //Clinical finding
