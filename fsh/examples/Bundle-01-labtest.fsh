...
* entry[0].resource = Inline-Instance-for-ips-Bundle-01-0
...
Instance: Inline-Instance-for-ips-Bundle-01-0
...
* status = #final
* type = LOINC#11502-2 "Lab Test report"
...
* title = "Proof of Negative Covid-19 Test"
...
* section[0].title = "Laboratory Test"
* section[0].code = LOINC#19146-0 "Reference lab test panel"
* section[0].text.status = #generated
* section[0].text.div = "<div>Nothing here</div>"
* section[0].entry[0].reference = "urn:uuid:1d3bc2de-1fa4-4680-b605-b6d866059898" 
...
* recommendation[0].doseNumberPositiveInt = 0
* recommendation[0].seriesDosesPositiveInt = 0
...
//* performer[0].actor.reference = "urn:uuid:d7a490a1-d267-4785-ac98-db56748827fb" 
* protocolApplied[0].targetDisease[0] = SCT#16541001 "Yellow fever (disorder)"
* protocolApplied[0].doseNumberPositiveInt = 0
* protocolApplied[0].seriesDosesPositiveInt = 0
